...
public class FragmentImageOri extends Fragment implements ImageViewActivityAdapter.ImageViewClicked {
    ...
    public FragmentImageOri() {
        // Required empty public constructor
    }

    public FragmentImageOri(String activityValue) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=getLayoutInflater().inflate(R.layout.fragment_image_ori,null);
        RecyclerView recyclerView=view.findViewById(R.id.fragmentImageRecycler_Ori);
        GridLayoutManager manager=new GridLayoutManager(getActivity(),2);
        recyclerView.setLayoutManager(manager);
        list=new PublicMethod(this.getActivity()).getPictureListsOri();
        ImageViewActivityAdapter adapter=new ImageViewActivityAdapter(list,this);
        recyclerView.setAdapter(adapter);
        txt=view.findViewById(R.id.fragmentImageText_ori);
